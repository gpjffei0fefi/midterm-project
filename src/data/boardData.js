...
export const INITIAL_PLAYERS = [
  { id: 'p1', name: 'Player 1', color: '#43D9C8', position: 0, accuracy: 26, fairness: 23, transparency: 23, isAI: false },
  { id: 'p2', name: 'Player 2', color: '#E85D9E', position: 0, accuracy: 20, fairness: 19, transparency: 19, isAI: true },
  { id: 'p3', name: 'Player 3', color: '#F2C14E', position: 0, accuracy: 29, fairness: 28, transparency: 28, isAI: true },
]
